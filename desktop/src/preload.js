...
contextBridge.exposeInMainWorld("openflow", {
  ...
  getSpeechModelStatus: (modelName) => ipcRenderer.invoke("speech-model:status", modelName),
  downloadSpeechModel: (modelName) => ipcRenderer.invoke("speech-model:download", modelName),
  deleteSpeechModel: (modelName) => ipcRenderer.invoke("speech-model:delete", modelName),
  onSpeechModelUpdate: (callback) => subscribe("speech-model:update", callback),
  openAdvancedSettings: () => ipcRenderer.invoke("advanced-settings:open"),
  getAppStatus: () => ipcRenderer.invoke("app-status:get"),
  onAppStatusUpdated: (callback) => subscribe("app-status:updated", callback),
